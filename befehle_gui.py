...
#    Jul 05, 2020 05:33:00 PM CEST  platform: Windows NT
...
w = None
def create_Toplevel1(root,serialref, *args, **kwargs):
    ...
    befehle_gui_support.set_Tk_var()
    top = Toplevel1 (w)
    befehle_gui_support.init(w, top,serialref, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.TButton_Send_Offset.configure(cursor="fleur")
        ...
        self.TEntry1 = ttk.Entry(self.TLabelframe1)
        self.TEntry1.place(relx=0.364, rely=0.19, relheight=0.238, relwidth=0.3
                , bordermode='ignore')
        self.TEntry1.configure(textvariable=befehle_gui_support.sollwert)
        self.TEntry1.configure(takefocus="")
        self.TEntry1.configure(cursor="ibeam")
        ...
        self.TLabelframe2.configure(cursor="fleur")
        ...
        self.TLabel1_2.configure(cursor="fleur")
        ...
        self.TLabelframe3.place(relx=0.484, rely=0.028, relheight=0.526
                , relwidth=0.466)
        self.TLabelframe3.configure(relief='')
        self.TLabelframe3.configure(text='''Overwrite''')
        self.TLabelframe3.configure(cursor="fleur")

        self.TLabel3 = ttk.Label(self.TLabelframe3)
        self.TLabel3.place(relx=0.04, rely=0.108, height=23, width=46
                , bordermode='ignore')
        ...
        self.TLabel3_6.place(relx=0.04, rely=0.27, height=23, width=46
                , bordermode='ignore')
        ...
        self.TLabel3_7.place(relx=0.04, rely=0.432, height=23, width=46
                , bordermode='ignore')
        ...
        self.TLabel3_8.place(relx=0.04, rely=0.595, height=23, width=46
                , bordermode='ignore')
        ...
        self.TEntry_Ovewrite1.place(relx=0.28, rely=0.108, relheight=0.135
        ...
        self.TEntry_Ovewrite2.place(relx=0.28, rely=0.27, relheight=0.135
                , relwidth=0.664, bordermode='ignore')
        ...
        self.TEntry_Ovewrite3.place(relx=0.28, rely=0.432, relheight=0.135
                , relwidth=0.664, bordermode='ignore')
        ...
        self.TEntry_Ovewrite4.place(relx=0.28, rely=0.595, relheight=0.135
                , relwidth=0.664, bordermode='ignore')
        ...
        self.TButton_overwrite.place(relx=0.08, rely=0.757, height=29, width=98
                , bordermode='ignore')
        ...
        self.TButton_overwrite.configure(cursor="fleur")

        self.TButton_regelung = ttk.Button(self.TLabelframe3)
        self.TButton_regelung.place(relx=0.52, rely=0.757, height=29, width=98
                , bordermode='ignore')
        ...
        self.sonstiges.place(relx=0.484, rely=0.568, relheight=0.327
                , relwidth=0.466)
        self.sonstiges.configure(relief='')
        self.sonstiges.configure(text='''sonstiges''')

        self.TButton1 = ttk.Button(self.sonstiges)
        self.TButton1.place(relx=0.04, rely=0.174, height=29, width=58
                , bordermode='ignore')
        ...
        self.TButton1_13.place(relx=0.32, rely=0.174, height=29, width=88
                , bordermode='ignore')
        ...
        self.TButton1_14.place(relx=0.04, rely=0.522, height=29, width=58
                , bordermode='ignore')
