...
class serialPlot:
    ...
    def getSerialData(self, frame, lines, lineValueText, lineLabel, timeText):
        ...
        for i in range(self.numPlots):
            ...
            lineValueText[i].set_text('[' + lineLabel[i+3] + '] = ' + str(value))
            lines[i+3].set_data(range(self.plotMaxLength), self.data[i])
            lineValueText[i+3].set_text('[' + lineLabel[i+3] + '] = ' + str(value))
...
def main():
    ...
    for i in range(numPlots):
        ...
        lineValueText.append(ax2.text(0.50, 0.90 - i * 0.05, '', transform=ax2.transAxes))
